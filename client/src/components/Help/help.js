...
<div className="card-body">
        ...
        <h6 className="card-subtitle mb-2 text-muted">Speake with a professional</h6>
...
<div className="Card-body">
        ...
        <h6 className="Card-subtitle mb-2 text-muted">Seekign Financial Help?</h6>
...
<div className="Card-body">
        ...
        <a href="https://suicidepreventionlifeline.org/" className="Card-link">Go to SicidePreventionLifeLine.org</a>
  </div>
</div>
